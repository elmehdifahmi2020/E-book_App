...
class AudioBook : Fragment(),CustomAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bookList.add(ModelBook("AudioBook1",R.drawable.audiobook))
        bookList.add(ModelBook("AudioBook2",R.drawable.audiobook))
        bookList.add(ModelBook("AudioBook3",R.drawable.audiobook))
        bookList.add(ModelBook("AudioBook4",R.drawable.audiobook))
        bookList.add(ModelBook("AudioBook5",R.drawable.audiobook))
        bookList.add(ModelBook("AudioBook6",R.drawable.audiobook))
        bookList.add(ModelBook("AudioBook7",R.drawable.audiobook))
        bookList.add(ModelBook("AudioBook8",R.drawable.audiobook))
        bookList.add(ModelBook("AudioBook9",R.drawable.audiobook))
        bookList.add(ModelBook("AudioBook10",R.drawable.audiobook))
        bookList.add(ModelBook("AudioBook11",R.drawable.audiobook))
